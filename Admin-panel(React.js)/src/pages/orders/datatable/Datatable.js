...
const [data,setData] = useState([])
  ...
  const userColumns = [{field:"_id",headerName:"_id",width:50},
        {field:"customer_name",headerName:"customerId",width:150},
        {field:"phone",headerName:"phone",windth:100},
 ...
 axios.get("/read/users").then((result)=>{
  ...
  return (
    ...
    <div className='datatable' >
      ...
      {/* <button className='add_item' onClick={()=> window.location.href='http://localhost:3000/menus/new'}>Add New Dish</button> */}
